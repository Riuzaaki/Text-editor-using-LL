...
public:
    ...
    linked_list()
    {
        ...
        while (choice != 0)
        {
            ...
            cin >> choice;
            cout << endl;
            if (choice == 1) // Insertion of a line
            {
                int lineGiven;
                string dataGiven;
            ...
            else if (choice == 2) // Deletion of a line
            {
                int lineGiven;
            ...
            else if (choice == 3) // Interchanging two lines
            {
                int lineGiven1;
                int lineGiven2;
            ...
            else if (choice == 5) // Printing the whole list
            {
                printall();
    ...
    { // an extra function used to add to tail, had to implement to make Undo function work
        if (head == NULL)
        {
            node *temp;
            temp = new node;
    ...
    { // an extra function used to delete from tail, had to implement to make Undo function work
        node *temp = head;
        if (head == NULL)
        {
    ...
    {                     // this function will add to Tail
    ...
    void deleteTail()
    { // function used to delete the very last element, and update the tail
        node *temp = head;
        if (head == NULL)
        {
            cout << "Nothing to be deleted." << endl;
    ...
    { // will print /n lines if given line is larger than numOfLines
    ...
    { // function used to Move line N into line M
        if (nLineGiven == 1)
        {
    ...
    { // function used to print only one page, only 10 or if there are less than 10 lines, it'll print only those lines
        node *temp = head;
        ...
        {
            cout << " you want to print an inexisting page" << endl;
        }
    }

    void openFile()
    { // function used to open a file from the same folder this cpp file is in
        string fileName;
